...
import { getUserId, User } from '../services/api/authApi';
...
type RootStackParamList = {
  ...
  VO2maxSessionSummary: { sessionId: number };
  Dashboard: undefined;
};

type VO2maxWorkoutScreenRouteProp = RouteProp<RootStackParamList, 'VO2maxWorkout'>;
...
export default function VO2maxWorkoutScreen() {
  ...
  const route = useRoute<VO2maxWorkoutScreenRouteProp>();
  ...
  const handleViewDetails = () => {
    ...
    if (sessionData?.session_id) {
      ...
      navigation.navigate('Analytics', { sessionId: sessionData.session_id });
    } else {
