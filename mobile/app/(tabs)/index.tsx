...
import { useRecoveryStore, getRecoveryMessage } from '../../src/stores/recoveryStore';
...
import { MuscleGroupVolumeBar } from '../../src/components/analytics/MuscleGroupVolumeBar';
...
export default function DashboardScreen() {
  ...
  const handleSubmitRecoveryAssessment = async () => {
    if (!sleepQuality || !muscleSoreness || !mentalMotivation || !userId) {
      return;
    }
